...
The Best Buy exact-model asset `ninja-crispi-gray.webp` clearly shows the gray Ninja Crispi PowerPod with its glass cooking containers. Image-search results for model FN101GY also show matching gray Crispi system views with the large and small glass containers and storage lids. These exact-model images are suitable replacements.
The second verified image `Z4TWzWMnzYFm.jpg` shows the gray Ninja Crispi PowerPod with both glass containers, storage lids, and the complete cooking-system layout. It matches the FN101GY product family and is suitable as the secondary catalog image.
