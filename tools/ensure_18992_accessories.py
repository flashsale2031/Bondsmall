...
TARGET_ID = 18992
CATALOG_FILE = ROOT / "catalog-pages" / "products-page-00950.js"
...
for product in records:
    if int(product.get("id", 0)) == TARGET_ID:
        found = product
        for key, value in (("category", "accessories"), ("gender", "Unisex"), ("productType", "accessories")):
...
(ROOT / "product-18992-accessories-update-report.json").write_text(
