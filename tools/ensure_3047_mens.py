...
TARGET_ID = 3047
CATALOG_FILE = ROOT / "catalog-pages" / "products-page-00153.js"
...
for product in records:
    if int(product.get("id", 0)) == TARGET_ID:
        found = product
        for key, value in (("category", "men"), ("gender", "Men"), ("productType", "men")):
...
report = {
    ...
    "changed": changed,
    "image_count": len(found.get("images") or []),
}
(ROOT / "product-3047-mens-update-report.json").write_text(
