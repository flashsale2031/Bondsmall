...
DEST=ROOT/'assets/mens/page2-main-corrections/2225.webp'
...
for path in sorted((ROOT/'catalog-pages').glob('products-page-*.js')):
    ...
    for p in products:
        if p.get('id')==PID:
            p['image']='assets/mens/page2-main-corrections/2225.webp'; imgs=p.get('images') or []; p['images']=['assets/mens/page2-main-corrections/2225.webp']+imgs[1:] if imgs else ['assets/mens/page2-main-corrections/2225.webp']; p['source_url']=SOURCE_URL; p['main_image_source_url']=SOURCE_URL; p['main_image_source_title']=SOURCE_TITLE; p['main_image_source_search_engine']='Yahoo Images exact-product search'; found=True; changed=True
    if changed:
...
report={'id':PID,'replacement':'assets/mens/page2-main-corrections/2225.webp','source_url':SOURCE_URL,'source_title':SOURCE_TITLE}
