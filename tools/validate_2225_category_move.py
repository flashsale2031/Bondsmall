...
assert found['images']==['assets/mens/page2-main-corrections/2225.jpg','assets/main-images/hf-684.jpg']
idx=(ROOT/'catalog-category-index.js').read_text(encoding='utf-8')
assert '"men":{"count":237' in idx
assert '"women":{"count":22536' in idx
assert (ROOT/'assets/mens/page2-main-corrections/2225.jpg').exists()
assert (ROOT/'assets/main-images/hf-684.jpg').exists()
